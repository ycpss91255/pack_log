...
- 342 tests across unit, local integration, and remote integration test suites. CI runs as non-root for realistic permission testing.
...
│   ├── test_file_finder.bats            # File finder tests (31)
│   ├── test_file_ops.bats              # File operation tests (43)
...
342 tests (279 unit + 21 local integration + 31 remote integration). See **[TEST.md](doc/test/TEST.md)** for full details.
