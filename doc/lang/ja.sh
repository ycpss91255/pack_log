...
MSG_HELP_START='    -s, --start <YYYYmmdd-HHMMSS>  開始時刻 (例: 20260101-000000)'
MSG_HELP_END='    -e, --end <YYYYmmdd-HHMMSS>    終了時刻 (例: 20260101-235959)'
MSG_HELP_OUTPUT='    -o, --output <パス>           出力フォルダパス'
...
# --- 時刻処理 ---
MSG_TIME_PROMPT='%s を入力 (YYYYmmdd-HHMMSS): '
