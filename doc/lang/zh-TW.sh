...
MSG_HELP_START='    -s, --start <YYYYmmdd-HHMMSS>  起始時間 (例: 20260101-000000)'
MSG_HELP_END='    -e, --end <YYYYmmdd-HHMMSS>    結束時間 (例: 20260101-235959)'
MSG_HELP_OUTPUT='    -o, --output <路徑>           輸出資料夾路徑'
...
# --- 時間處理 ---
MSG_TIME_PROMPT='輸入 %s (YYYYmmdd-HHMMSS): '
