...
- **100% テストカバレッジ**：単体テスト、ローカル結合テスト、リモート結合テストで合計 318 件のテスト。
...
318 テスト（274 ユニット + 17 ローカル結合 + 27 リモート結合）、**100% コードカバレッジ**。詳細は **[TEST.ja.md](../TEST.ja.md)** を参照。
